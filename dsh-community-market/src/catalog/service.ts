...
import { DSH_1024STORE_ADAPTER_ID, dsh1024StoreAdapter } from '../adapters/dsh-1024store.js'
import { dshfindAdapter } from '../adapters/dshfind.js'
import { standardHttpAdapter } from '../adapters/standard-http.js'
import { BUILT_IN_PROVIDERS } from './built-in-providers.js'

export { BUILT_IN_PROVIDERS, type BuiltInProviderDefinition } from './built-in-providers.js'
...
function sourceView(record: LocalSourceRecord): MarketSourceView {
  ...
  return {
    ...
    ...(builtIn === undefined ? {} : { descriptionKey: builtIn.descriptionKey }),
