...
enum TourScript {
    ...
    static let steps: [TourStep] = [
        ...
        TourStep(
            ...
            icon: "sidebar.left",
            title: "Your sessions",
            body: "Each folder you work in gets its own session, listed here. They keep running side by side, so you can leave Claude working on one and switch to another. Unread chats turn bold, and each shows what Claude's up to live.\n\nUse + to start a new one — and every project has a shared note all its chats can see."
        ),
        TourStep(
            target: .files,
            icon: "folder",
        ...
        TourStep(
            ...
            body: "Choose which Claude model to use and how long it should think before answering.\n\nSkills and commands are reusable instructions you've saved — pick one and it drops straight into the box, ready to send."
        ),
        TourStep(
            target: .flow,
            icon: "arrow.triangle.branch",
            title: "Plan the big jobs",
            body: "For anything with a few steps, flip to Flow. Sketch the plan out as cards, let Claude look it over, then hand the whole thing across at once.\n\nYour flows are saved and ready to reuse in any project."
        ),
        TourStep(
