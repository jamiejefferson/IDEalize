...
/**
 * The draft row for one discovered model: id, and the name and capacities the
 * provider reported. Exported for the custom-provider card, which adopts a
 * whole discovery at once (JJ, 2 Sep 2026: URL and key, nothing else).
 * @param candidate - one discovered model.
 * @returns its draft row.
 */
export function adopt(candidate: DiscoveredModelView): ModelDraft {
  return {
    id: candidate.id,
