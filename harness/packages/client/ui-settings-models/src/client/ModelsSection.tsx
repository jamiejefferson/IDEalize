          ...
          ? (
            <div className={styles['addCard']}>
              <div className={styles['field']}>
                ...
                {/* The select holds only the shipped catalog, which reads as
                    the boundary of what can be added; the declare path stays
                    reachable from where that conclusion is drawn. */}
                <p className={styles['notListedRow']}>
                  {t('notListed')}
                  <button
                    type="button"
