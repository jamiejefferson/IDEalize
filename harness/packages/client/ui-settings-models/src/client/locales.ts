...
export const en = {
  ...
  notListed: 'Need a provider that is not listed?',
  ...
  customLead: 'Paste the endpoint and your key. The rest is worked out from them; open More options to change it.',
  customChecking: 'Asking {host} for its models…',
  customFound: '{count} models found. Ready to create.',
  customFoundNone: '{host} listed no models. Add one under More options.',
  customCheckFailed: 'Could not read models from {host}: {message}',
  customUrlInvalid: 'Enter a full URL, starting with https://.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  customLead: '粘贴端点和你的密钥，其余项将自动推算；如需修改，请展开“更多选项”。',
  customChecking: '正在向 {host} 获取模型…',
  customFound: '已找到 {count} 个模型，可以创建。',
  customFoundNone: '{host} 未列出任何模型。请在“更多选项”中添加。',
  customCheckFailed: '无法从 {host} 读取模型：{message}',
  customUrlInvalid: '请输入以 https:// 开头的完整 URL。',
  moreOptions: '更多选项',
  create: '创建提供方',
  creating: '创建中\u2026',
