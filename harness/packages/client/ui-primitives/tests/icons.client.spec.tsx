...
describe('FishLogo', () => {
  it('renders the IDE monogram in currentColor at the native ratio', () => {
    const { container } = render(<primitives.FishLogo />)
    const svg = container.querySelector('svg')!
    expect(svg.getAttribute('width')).toBe('24')
    expect(Number(svg.getAttribute('height'))).toBeCloseTo(24 * 19.4 / 25.4, 1)
    expect(svg.getAttribute('viewBox')).toBe('16 14.2 25.4 19.4')
