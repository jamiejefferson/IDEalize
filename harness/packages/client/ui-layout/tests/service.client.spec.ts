...
describe('LayoutController', () => {
  it('forwards the three panel actions to the attached set', () => {
    ...
    expect(panels.openDrawer).toHaveBeenCalledTimes(1)
    expect(panels.closeDrawer).toHaveBeenCalledTimes(1)
    expect(panels.openDeck).toHaveBeenCalledTimes(1)
    expect(panels.closeDeck).toHaveBeenCalledTimes(1)
