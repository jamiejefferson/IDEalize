...
/**
 * No runtime invariant: the plugin emits no cordis events and owns no mutable
 * cross-plugin state. Its Definition registrations and the `trajectorySection`
 * service are plain effects whose disposal the registries' own specs and this
