...
function WorkspaceProbe({ open, addOnly }: EmptyWorkspaceOwnerProps) {
  const [count, setCount] = useState(0)
  // The shell mounts a second, menu-less picker for the launcher's New-project
  // action; the probe watches the menu-bearing one.
  if (addOnly === true) return null
  return (
