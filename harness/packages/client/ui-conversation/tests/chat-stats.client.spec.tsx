...
describe('StatsLine', () => {
  ...
  it('renders the grouped stats row and keeps an empty seat for a brand-new session', () => {
    ...
    // The seat stays so the composer card does not drop by the row's height.
    expect(emptyView.container.firstElementChild?.getAttribute('aria-hidden')).toBe('true')
  })
