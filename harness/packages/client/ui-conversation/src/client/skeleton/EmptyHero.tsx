// Hero chrome for the blank-draft phase of ConversationRoot: owl + headline,
...
import {
  IconChevronDownOutline14, IconFolderClose16, IconFolderOpen16, OwlMark,
...
export function HeroShell({ t, children }: HeroShellProps) {
  return (
    // `data-hero-shell`: ConversationRoot's CSS retires the hero chrome when a
    // blank chat's ring sits on a non-chat view, and cannot reach this
    // package's hashed class names.
    <div className={css.root} data-hero-shell="">
      <div className={css.stack}>
        {/* V0's welcome slate: the owl presides above the headline. */}
        <span className={css.owlPerch}>
          <OwlMark size={104} animate />
        </span>
