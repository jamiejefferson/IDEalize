...
export const zh = {
  ...
  'menu.empty': '暂时没有',
  'menu.search': '搜索…',
  'menu.noMatch': '没有匹配的项目',
  'input.attachUnavailable': '这个文件只能拖入或粘贴',
  'input.commands': '命令',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  ...
  'input.return.sends': 'Enter 发送，点击改为换行',
  'input.return.newline': 'Enter 换行，点击改为发送',
  'hero.recents': '最近的项目',
...
export const en = {
  ...
  'placeholder.default': 'What do you want to Idealize?',
  ...
  'placeholder.hero': 'What do you want to Idealize?',
  'placeholder.workspace': 'Choose a project to start',
  'input.attach': 'Attach files',
  'input.menu': 'Add',
  'menu.attach': 'Add files or photos',
  'menu.loading': 'Loading…',
  'menu.empty': 'Nothing here yet',
  'menu.search': 'Search…',
  'menu.noMatch': 'No matches',
  'input.attachUnavailable': 'This file can only be dropped or pasted in',
  'input.commands': 'Commands',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'input.return.sends': 'Return sends — click so Return starts a new line',
  'input.return.newline': 'Return starts a new line — click so Return sends',
  'hero.recents': 'Recent projects',
  ...
  'hero.headline': 'What shall we Idealize?',
  'hero.chooseWorkspace': 'Choose a project',
