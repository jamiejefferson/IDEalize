 ...
 * document. (IDEalize fork: the Appearance row is no longer registered into
 * the settings General section — the bar's theme-cycle button owns the
 * preference until the dedicated Appearance pane lands; AppearanceRow stays
 * exported for that pane.)
 */
...
/**
 * Client plugin body: provide the theme service and register the settings-row
 * copy dictionaries (kept for the future Appearance pane; no row registers).
