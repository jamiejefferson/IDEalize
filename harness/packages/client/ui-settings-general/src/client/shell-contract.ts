...
/** One programmatic open request (tick 0 = none yet; section optional). */
...
export type SettingsRootInjected = {
  hooks: {
    ...
    /** ctx.settingsOpen requests (IDEalize fork seam; see ui-settings). */
    openRequests: HostObservable<SettingsOpenRequest>
  }
}
