/**
 * the Studio host face contributes no host behaviour and serves no route.
 * Every record the Studio pane shows travels over `@idealize/studio`'s
 * routes, so this half must add nothing to the host.
 */

import { Context } from '@deepseek-ai/cordis'
import { describe, expect, it } from 'vitest'
import { apply } from '@idealize/ui-studio'

const PACKAGE_NAME = '@idealize/ui-studio'

describe('the Studio host face', () => {
