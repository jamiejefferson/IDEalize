/**
 * the Schedule host face contributes no host behaviour and serves no route.
 * Every task the Schedule shows travels over `@idealize/cron`'s routes, so
 * this half must add nothing to the host.
 */

import { Context } from '@deepseek-ai/cordis'
import { describe, expect, it } from 'vitest'
import { apply } from '@idealize/ui-schedule'

const PACKAGE_NAME = '@idealize/ui-schedule'

describe('the Schedule host face', () => {
