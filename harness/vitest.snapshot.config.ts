...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      // IDEalize product packages own their assembled scenarios in-package:
      // the fork ships no runnable example of its own, and its compositions
      // mount `@idealize/*` rows no upstream example declares.
      'packages/idealize/*/tests/**/*.snapshot.ts',
    ],
