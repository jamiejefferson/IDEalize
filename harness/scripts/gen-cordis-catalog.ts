...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  idealizeAttribution: 'token-meter.md',
  idealizeBridge: 'web-server.md',
  idealizeComm: 'web-server.md',
  idealizeStudio: 'web-server.md',
  idealizeTerminals: 'web-server.md',
  idealizeSkills: 'skills.md',
  transcription: 'web-server.md',
  idealizeCron: 'schedule.md',
  idealizeOAuth: 'credentials.md',
  artefacts: 'storage.md',
  generation: 'jobs.md',
  docPolicy: 'workspace.md',
  workspaceAliases: 'workspace.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  settingsOpen: 'client-side interface-typed settings modal opener — packages/client/ui-settings/README.md owns the API',
  agentPresetSection: 'client-side section component carrier for the Models & usage panel — packages/client/ui-agent-preset/README.md owns the API',
  modelsSettingsSection: 'client-side section component carrier for the Models & usage panel — packages/client/ui-settings-models/README.md owns the API',
  trajectorySection: 'client-side ledger component carrier for the Trajectory rail pane — packages/client/ui-trajectory/README.md owns the API',
  ...
  composerMenu: 'client-side interface-typed registry (ComposerMenuContract) for the composer "+" menu — packages/client/ui-conversation/README.md owns the API',
  ...
  activityPills: 'client-side activity-brain controller face — packages/idealize/activity-pills/README.md owns the API',
  appearance: 'client-side appearance panel service — packages/idealize/appearance/README.md owns the API',
  idealizeNotify: 'client-side notification output devices — packages/idealize/notify/README.md owns the API',
  idealizeBar: 'client-side tool-rail pane service — packages/idealize/ui-bar/README.md owns the API',
  scheduleSection: 'client-side calendar component carrier for the Schedule rail pane — packages/idealize/ui-schedule/README.md owns the API',
  studioSection: 'client-side coordination view carrier for the Studio rail pane — packages/idealize/ui-studio/README.md owns the API',
  terminalMode: 'client-side chat/terminal toggle host — packages/idealize/ui-terminal/README.md owns the API',
  keybinds: 'client-side keybind catalogue and dispatcher — packages/idealize/ui-tour/README.md owns the API',
  tour: 'client-side first-run tour face — packages/idealize/ui-tour/README.md owns the API',
}
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  CronRun: 'scheduled run record is owned by packages/idealize/cron/src/store.ts',
  CronTask: 'scheduled task definition is owned by packages/idealize/cron/src/store.ts',
  TaskView: 'HTTP task projection is owned by packages/idealize/cron/src/index.ts',
  CommMessage: 'mailbox message payload is owned by packages/idealize/comm/src/wire.ts',
  StudioEvent: 'Studio timeline record is owned by packages/idealize/studio/src/events.ts',
  StudioEventInput: 'Studio event submission is owned by packages/idealize/studio/src/events.ts',
  StudioAppendResult: 'Studio append outcome is owned by packages/idealize/studio/src/store.ts',
  CatalogueGroup: 'skills folder catalogue group is owned by packages/idealize/skills/src/index.ts',
  StudioState: 'Studio folded project state is owned by packages/idealize/studio/src/fold.ts',
  DeliveryState: 'Studio delivery state is owned by packages/idealize/studio/src/fold.ts',
  StudioPresence: 'Studio runtime presence is owned by packages/idealize/studio/src/index.ts',
  TranscriptionProvider: 'speech provider registration is owned by packages/idealize/transcribe/src/types.ts',
  TranscriptionDescriptor: 'speech provider row is owned by packages/idealize/transcribe/src/types.ts',
  TranscriptionReadiness: 'speech model readiness is owned by packages/idealize/transcribe/src/types.ts',
  TranscriptionRequest: 'speech capture submission is owned by packages/idealize/transcribe/src/types.ts',
  TranscriptionSpec: 'resolved speech capture is owned by packages/idealize/transcribe/src/types.ts',
  TranscriptionResult: 'speech transcript record is owned by packages/idealize/transcribe/src/types.ts',
  OAuthProviderStatus: 'sign-in status row is owned by packages/idealize/provider-pack/src/index.ts',
  ArtefactCreateRequest: 'artefact intake contract is owned by packages/idealize/artefacts/src/index.ts',
  ArtefactId: 'artefact record identity is owned by packages/idealize/artefacts/src/types.ts',
  ArtefactListFilter: 'artefact listing filter is owned by packages/idealize/artefacts/src/index.ts',
  ArtefactRecord: 'durable artefact record is owned by packages/idealize/artefacts/src/types.ts',
  ArtefactDisposition: 'keep/archive verdict vocabulary is owned by packages/idealize/artefacts/src/types.ts',
  ArtefactFolderSettings: 'media folder settings are owned by packages/idealize/artefacts/src/settings.ts',
  BackendCredentialState: 'the media-key row is owned by packages/idealize/generate/src/types.ts and its README',
  StudioOverviewProject: 'the per-project overview row is owned by packages/idealize/studio/src/index.ts and its README',
  StudioChatPost: 'the Studio chat post outcome is owned by packages/idealize/studio/src/index.ts and its README',
  CommRequest: 'command wire request is owned by packages/idealize/comm/src/wire.ts',
  CommResponse: 'command wire response is owned by packages/idealize/comm/src/wire.ts',
  CommRole: 'session role vocabulary is owned by packages/idealize/comm/src/store.ts',
  RosterEntry: 'addressable session row is owned by packages/idealize/comm/src/service.ts',
  DocScanRecord: 'documentation scan record is owned by packages/idealize/doc-policy/src/spec.ts',
  DocsSearchHit: 'documentation search hit is owned by packages/idealize/doc-policy/src/search.ts',
  DocsState: 'documentation state projection is owned by packages/idealize/doc-policy/src/index.ts',
  ProjectDocsFolder: 'project documentation folder lookup result is owned by packages/idealize/doc-policy/src/notes-lookup.ts',
  RulesetVersion: 'pinned ruleset version is owned by packages/idealize/doc-policy/src/policy/ruleset.ts',
  CapabilityRequirement: 'generation capability requirement is owned by packages/idealize/generate/src/types.ts',
  GenCatalogEntry: 'generation catalogue entry is owned by packages/idealize/generate/src/types.ts',
  GenerationAvailability: 'generation availability projection is owned by packages/idealize/generate/src/types.ts',
  GenerationBackend: 'generation backend descriptor is owned by packages/idealize/generate/src/types.ts',
  GenInputField: 'generation input field is owned by packages/idealize/generate/src/types.ts',
  GenModelRef: 'generation model reference is owned by packages/idealize/generate/src/types.ts',
  GenerationProgressSink: 'generation progress callback is owned by packages/idealize/generate/src/types.ts',
  GenerationRequest: 'generation request is owned by packages/idealize/generate/src/types.ts',
  GenerationResult: 'generation result is owned by packages/idealize/generate/src/types.ts',
  KvTable: 'storage-domain KV table handle is owned by packages/storage/storage-domain/src/domain.ts',
  OrientationRequest: 'first-run orientation request is owned by packages/idealize/setup/src/index.ts',
  OrientationResult: 'first-run orientation result is owned by packages/idealize/setup/src/index.ts',
  ProjectDocumentation: 'project documentation folder record is owned by packages/idealize/setup/src/index.ts',
  SetupState: 'setup state projection is owned by packages/idealize/setup/src/index.ts',
  WorkspaceAlias: 'workspace alias record is owned by packages/idealize/setup/src/index.ts',
  WorkspaceAliasName: 'workspace alias name vocabulary is owned by packages/idealize/setup/src/index.ts',
...
export function computeOutputs(): [string, string][] {
  ...
  for (const page of pages) {
    ...
    try {
      ...
      // The page must exist before a region can be injected; the generator names the miss.
