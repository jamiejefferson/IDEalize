...
/**
 * Validate lines 1-5 of an archived note. Notes sealed before the Chinese
 * corpus was removed (JJ, 16 Sep 2026) keep a language-switcher line 6 that
 * the frozen manifest hash protects; nothing reads it.
 */
...
/** Validate the closed kind tree and the implemented/archive headers. */
