...
Sources: [`packages/core/session/src/types.ts:336`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:343`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:372`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:415`](../packages/core/session/src/types.ts)
...
<a id="artefactcreated--log-only"></a>

#### `artefact/created` — log-only
...
Source: [`packages/idealize/artefacts/src/types.ts:112`](../packages/idealize/artefacts/src/types.ts)

<a id="artefactdisposition--log-only"></a>

#### `artefact/disposition` — log-only
...
Source: [`packages/idealize/artefacts/src/types.ts:126`](../packages/idealize/artefacts/src/types.ts)

<a id="artefactfailed--log-only"></a>

#### `artefact/failed` — log-only
...
Source: [`packages/idealize/artefacts/src/types.ts:119`](../packages/idealize/artefacts/src/types.ts)
...
<a id="generationrerouted--log-only"></a>

#### `generation/rerouted` — log-only
...
Source: [`packages/idealize/gen-tools/src/types.ts:34`](../packages/idealize/gen-tools/src/types.ts)
...
<a id="idealizeagent-name--log-only"></a>

#### `idealize/agent-name` — log-only
...
Source: [`packages/idealize/comm/src/projection-types.ts:27`](../packages/idealize/comm/src/projection-types.ts)

<a id="idealizebrain--log-only"></a>

#### `idealize/brain` — log-only
...
Source: [`packages/idealize/spaces/src/projection-types.ts:62`](../packages/idealize/spaces/src/projection-types.ts)

<a id="idealizespace--log-only"></a>

#### `idealize/space` — log-only
...
Source: [`packages/idealize/spaces/src/projection-types.ts:53`](../packages/idealize/spaces/src/projection-types.ts)
