...
Source: [`packages/idealize/askbar/src/index.ts:68`](../packages/idealize/askbar/src/index.ts)
...
Source: [`packages/idealize/comm/src/config.ts:12`](../packages/idealize/comm/src/config.ts)

<a id="idealizedoc-policy"></a>
...
Source: [`packages/idealize/feedback/src/index.ts:32`](../packages/idealize/feedback/src/index.ts)

<a id="idealizefreetokens"></a>
...
Source: [`packages/idealize/freetokens/src/index.ts:61`](../packages/idealize/freetokens/src/index.ts)

<a id="idealizegen-fixture"></a>
...
Depends on: [`GenArtefact`](../packages/idealize/generate/src/index.ts) · [`GenModality`](../packages/idealize/generate/src/index.ts)

Source: [`packages/idealize/gen-fixture/src/index.ts:45`](../packages/idealize/gen-fixture/src/index.ts)

<a id="idealizegen-tools"></a>
...
Source: [`packages/idealize/gen-tools/src/index.ts:41`](../packages/idealize/gen-tools/src/index.ts)

<a id="idealizehatch"></a>
...
Source: [`packages/idealize/models/src/index.ts:90`](../packages/idealize/models/src/index.ts)

<a id="idealizenotify"></a>
...
Source: [`packages/idealize/notify/src/index.ts:58`](../packages/idealize/notify/src/index.ts)

<a id="idealizeonboarding"></a>
...
Source: [`packages/idealize/onboarding/src/index.ts:44`](../packages/idealize/onboarding/src/index.ts)

<a id="idealizeservices"></a>

## `@idealize/services`

Requires: `llm` · `generation` · `settings` · `credentials` · `webServer`
...
Source: [`packages/idealize/services/src/index.ts:59`](../packages/idealize/services/src/index.ts)

<a id="idealizeskills"></a>
...
Source: [`packages/idealize/skills/src/index.ts:104`](../packages/idealize/skills/src/index.ts)

<a id="idealizestudio"></a>
...
Source: [`packages/idealize/studio/src/index.ts:500`](../packages/idealize/studio/src/index.ts)

<a id="idealizetelegram"></a>
...
Source: [`packages/idealize/telegram/src/index.ts:54`](../packages/idealize/telegram/src/index.ts)

<a id="idealizetranscribe"></a>
...
Depends on: `DataType` (`@huggingface/transformers`)

Source: [`packages/idealize/transcribe/src/index.ts:52`](../packages/idealize/transcribe/src/index.ts)

<a id="idealizeui-terminal"></a>
...
Source: [`packages/idealize/vault/src/index.ts:41`](../packages/idealize/vault/src/index.ts)

<a id="idealizeweb-search-openrouter"></a>
...
Source: [`packages/idealize/web-search-openrouter/src/index.ts:46`](../packages/idealize/web-search-openrouter/src/index.ts)
...
- `@idealize/appearance` ([`packages/idealize/appearance/src/index.ts`](../packages/idealize/appearance/src/index.ts))
- `@idealize/artefacts` — requires `storageDomain` · `workspaceRegistry` ([`packages/idealize/artefacts/src/index.ts`](../packages/idealize/artefacts/src/index.ts))
- `@idealize/cron` ([`packages/idealize/cron/src/index.ts`](../packages/idealize/cron/src/index.ts))
- `@idealize/host-bridge` ([`packages/idealize/host-bridge/src/index.ts`](../packages/idealize/host-bridge/src/index.ts))
- `@idealize/provider-pack` ([`packages/idealize/provider-pack/src/index.ts`](../packages/idealize/provider-pack/src/index.ts))
- `@idealize/setup` ([`packages/idealize/setup/src/index.ts`](../packages/idealize/setup/src/index.ts))
- `@idealize/skin` ([`packages/idealize/skin/src/index.ts`](../packages/idealize/skin/src/index.ts))
- `@idealize/spaces` ([`packages/idealize/spaces/src/index.ts`](../packages/idealize/spaces/src/index.ts))
- `@idealize/ui-bar` ([`packages/idealize/ui-bar/src/index.ts`](../packages/idealize/ui-bar/src/index.ts))
- `@idealize/ui-gallery` ([`packages/idealize/ui-gallery/src/index.ts`](../packages/idealize/ui-gallery/src/index.ts))
- `@idealize/ui-launch` ([`packages/idealize/ui-launch/src/index.ts`](../packages/idealize/ui-launch/src/index.ts))
- `@idealize/ui-schedule` ([`packages/idealize/ui-schedule/src/index.ts`](../packages/idealize/ui-schedule/src/index.ts))
- `@idealize/ui-soundstage` ([`packages/idealize/ui-soundstage/src/index.ts`](../packages/idealize/ui-soundstage/src/index.ts))
- `@idealize/ui-studio` ([`packages/idealize/ui-studio/src/index.ts`](../packages/idealize/ui-studio/src/index.ts))
- `@idealize/ui-tasks` ([`packages/idealize/ui-tasks/src/index.ts`](../packages/idealize/ui-tasks/src/index.ts))
- `@idealize/ui-tour` ([`packages/idealize/ui-tour/src/index.ts`](../packages/idealize/ui-tour/src/index.ts))
...
- `@idealize/bundle-idealize` ([`packages/idealize/bundle-idealize/src/index.ts`](../packages/idealize/bundle-idealize/src/index.ts))
- `@idealize/generate` ([`packages/idealize/generate/src/index.ts`](../packages/idealize/generate/src/index.ts))
