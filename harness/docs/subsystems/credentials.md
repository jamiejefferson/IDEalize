...
<a id="ctxidealizeoauth--idealizeoauth"></a>

### `ctx.idealizeOAuth` — `IdealizeOAuth`
...
Source: [`packages/idealize/provider-pack/src/index.ts:67`](../../packages/idealize/provider-pack/src/index.ts)
