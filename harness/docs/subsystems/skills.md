...
<a id="ctxidealizeskills--idealizeskillsservice"></a>

### `ctx.idealizeSkills` — `IdealizeSkillsService`
...
Source: [`packages/idealize/skills/src/index.ts:78`](../../packages/idealize/skills/src/index.ts)
