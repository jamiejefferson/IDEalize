# IDEalize V1 Documentation

This directory is the product and developer documentation index for IDEalize V1. The root [`README.md`](../README.md) is the short product entry point; these pages explain why the project exists, how to use it, and how to build plugins for it. Want to contribute? See [Contributing](../CONTRIBUTING.md).

## Read by goal

Ordinary users can start with the [user guide](user-guide.md) and never need the developer documentation.

### User documentation

| Document | Covers |
| --- | --- |
| [User guide](user-guide.md) | Installation, profiles, modes, terminal, plugins, and updates |
| [FAQ](faq.md) | Direct answers about platforms, bundled runtime, project status, data, plugins, and updates |
| [Why Desktop](why-desktop.md) | The boundary with the harness and the case for plugins |

### Developer and maintainer documentation

| Document | Covers |
| --- | --- |
| [Plugin ecosystem manifesto](plugin-ecosystem.md) | The vision of an open, composable, sustainable plugin ecosystem and its three principles |
| [Plugin development](plugin-development.md) | Harness plugins, Desktop services, compatibility, and lifecycle |
...
| [Architecture](architecture.md) | Electron, Host, loopback Web, profiles, and packaging |
...
The root [`README.md`](../README.md) is the product entry point. [`dsh-plugin-desktop/README.md`](../dsh-plugin-desktop/README.md) ships with the npm package and is the more technical package reference. `dsh-plugin-desktop/docs/` contains stable API contracts rather than marketing copy. `.agents/notes/implemented/` contains dated maintainer decision records and does not replace user documentation.
