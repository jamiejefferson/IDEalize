...
// The pnpm runtime also writes the `idealize` shim, so the smoke names the CLI the app names.
const idealizeCli = fileURLToPath(new URL('node_modules/@idealize/comm/lib/cli.js', packageRoot))
