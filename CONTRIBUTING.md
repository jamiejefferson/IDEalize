...
Thank you for wanting to contribute to IDEalize V1. This is a community project — whether you are a regular user, a plugin author, or a developer, there is a way to contribute that fits you.

## Regular users: use, report, and spread the word

- Report problems or odd behavior in an [issue](https://github.com/jamiejefferson/IDEalize/issues): include your operating system (macOS / Windows), application version, and reproduction steps.
- Feature ideas and improvement suggestions are welcome as issues too.
- Join the [community](README.md#community) and help other users.
- Write tutorials or experience posts, or help improve the documentation.

## Plugin authors: extend the ecosystem

IDEalize is built around plugins. If you write plugins, start with:

- [Plugin development](docs/plugin-development.md): how to write harness plugins and Desktop plugins.
- [DSH plugin ecosystem manifesto](docs/plugin-ecosystem.md): our vision of an open, composable, sustainable ecosystem, and the three principles — composition first, declare clearly, compatibility first.
...
If you would like to join the technical team, open an issue at <https://github.com/jamiejefferson/IDEalize/issues>.
